 ...
 * Info Admin Menu
 */
if ( ! class_exists( 'Kortez_Preschool_Theme_Info' ) ) {
    class Kortez_Preschool_Theme_Info{
        ...
        public function __construct( $config ) {
            ...
            /* Admin menu */
            add_action( 'admin_menu', array( $this, 'kortez_preschool_admin_menu' ) );
        ...
        public function prepare_class() {
            ...
            $this->page_title    = $this->theme_name . esc_html__( ' Info', 'kortez-preschool' );
        }
        
        /**
         * Adding Theme Info Menu under Appearance.
         */
        function kortez_preschool_admin_menu() {
            if ( ! empty( $this->page_title ) ) {
                add_theme_page( $this->page_title, esc_html__( 'Kortez Preschool Theme', 'kortez-preschool' ), 'edit_theme_options', $this->theme_slug . '-info', array(
                    $this,
                    'kortez_preschool_theme_info_screen',
                ) );
            }
        }
         ...
         */
        public function kortez_preschool_theme_info_screen() {
            ...
            if (
                ...
                echo '<a href="' . esc_url( 'https://kortezthemes.com/kortez-preschool-pro/' ).'" target="_blank">';
        ...
        public function style_and_scripts() {
            wp_enqueue_style( 'kortez-preschool-theme-info-css', get_template_directory_uri() . '/inc/admin/info.css' );
...
$config = array(
    ...
    // Main welcome title
    'info_title' => sprintf( esc_html__( 'Welcome to %s - ', 'kortez-preschool' ), $theme_name_config ),

    // Main welcome content
    'info_content' => sprintf( esc_html__( 'Kortez Preschool Pro offers more features and enhances your experience!', 'kortez-preschool' ), '<b>'.$theme_name_config.'</b>' ),
    ...
    'quick_links' => array(
        'theme_url'  => array(
            'text' => __( 'Buy Pro', 'kortez-preschool' ),
            'url' => 'https://kortezthemes.com/kortez-preschool-pro/'
        )
    ),
);

return new Kortez_Preschool_Theme_Info( $config );